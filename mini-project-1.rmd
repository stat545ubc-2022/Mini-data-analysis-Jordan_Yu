...
-   Now we have found that some biomarkers (variables) could be used for classifying subjects, while others may not. All 4 questions are yielding interesting results. However, we only selected 4 biomarkers out of interest, and we need to finish exploring the rest biomarkers to see whether any of them would also be good choices for classifying subjects.
